        ...
        {futureLetters.map((letter, index) => {
          ...
          return (
            <motion.div
              ...
              className={cn(
                'group relative flex cursor-pointer flex-col justify-between overflow-hidden rounded-3xl p-8 shadow-sm ring-1 transition-all hover:-translate-y-1 hover:shadow-md',
                canOpen
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="mb-2 font-serif text-2xl font-medium leading-tight text-stone-900">
                  {letter.title}
                </h3>
        ...
        {selectedLetter && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-2xl overflow-hidden rounded-[2rem] bg-[#FDFBF7] p-8 shadow-2xl sm:p-12"
              onClick={(e) => e.stopPropagation()}
            >
              <button
                onClick={() => setSelectedLetter(null)}
                className="absolute right-6 top-6 rounded-full bg-stone-100 p-2 text-stone-500 transition-colors hover:bg-stone-200 hover:text-stone-900"
              >
                <X className="h-5 w-5" />
              </button>
              ...
              <div className="prose prose-stone prose-lg mx-auto font-serif leading-relaxed text-stone-700">
                <p className="whitespace-pre-wrap">{selectedLetter.content}</p>
              </div>
              
              <div className="mt-12 text-center font-serif italic text-stone-400">
                With all my love.
              </div>
            </motion.div>
          </motion.div>
